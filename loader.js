...
Use this code for your bookmarklet:

```javascript
javascript:(function(){
    var win = window.open('https://ripplelearning.github.io/wcag-database/tool.html', 'WCAG_TOOL', 'width=800,height=600');
    if (win) {
        win.resizeTo(800, 600);
        win.focus();
        setTimeout(function(){ if(win.document.getElementById('s')) win.document.getElementById('s').focus(); }, 300);
    }
})();
